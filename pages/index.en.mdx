...
![mempool.space's transactions by fee rate since 2020](/mempool_incoming.png)
...
* Wanna see what a spam-free mempool looks like? [Take a look at this one](https://orangepill.ovh), hosted by [@leo_haf](https://twitter.com/leo_haf)
...
![Evolution of UTXO set size](/utxo_set.png)
...
There is the example of the spam in Bitcoin: 
...
"[inscription with input and output](https://mempool.space/fr/tx/3e35e0c6f33c47a77dc4639a7c9ff256db51ab7687c39d1b67f8e356410c5249)"
...
![Mechanism used to inscribe the Genesis block message by Satoshi](/genesis_coinbase_data.jpeg)
...
This contortionism aimed at protecting the inscriptions’ circus is worrying. Faced with this *Commedia dell'arte*, Luke has taken the lead by developing the "ordirespector" patch. Head to the [Install page](/install) to learn more about running this patch or even running an alternative Bitcoin Core client, Bitcoin Knots, that does not relay spammy transactions.
...
* Be vocal about your concerns, join discussions

### blabla 

blalblalbla 

## History of spam in the bitcoin network
...
![Block 832,849](/marathon_block.png)
...
![Satoshi's comments about BitDNS](/satoshi_bitdns.png)
